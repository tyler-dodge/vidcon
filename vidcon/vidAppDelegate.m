...
@synthesize shouldReloadNews = _shouldReloadNews;
@synthesize newsDelegate = _newsDelegate;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.parseQueue = dispatch_queue_create("com.stingapps.vidcon.parse", DISPATCH_QUEUE_SERIAL);
...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo {
    ...
    self.shouldReloadNews = YES;
    id delegate = self.newsDelegate;
    [delegate vidAppDelegate:delegate];
}
